...
if [ $OS = "ubuntu" ]; then
	...
	wget -q --show-progress --progress=bar:force:noscroll https://ports.ubuntu.com/pool/main/m/mysql-8.0/mysql-client-core-8.0_8.0.45-0ubuntu0.22.04.1_arm64.deb
	wget -q --show-progress --progress=bar:force:noscroll https://ports.ubuntu.com/pool/main/m/mysql-8.0/mysql-client-8.0_8.0.45-0ubuntu0.22.04.1_arm64.deb
	wget -q --show-progress --progress=bar:force:noscroll https://ports.ubuntu.com/pool/main/m/mysql-8.0/libmysqlclient-dev_8.0.45-0ubuntu0.22.04.1_arm64.deb
	wget -q --show-progress --progress=bar:force:noscroll https://ports.ubuntu.com/pool/main/m/mysql-8.0/libmysqlclient21_8.0.45-0ubuntu0.22.04.1_arm64.deb
