...
meson compile -C build
 wget -nv --show-progress --progress=bar:force:noscroll -O build/server/scrcpy-server https://github.com/Genymobile/scrcpy/releases/download/v3.3.4/scrcpy-server-v3.3.4
