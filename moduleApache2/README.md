...
`moduleApache2` is a custom Apache2 module to authorize and auto-login the user for the different modules.

# Compilation of this folder
To compile this folder:
* OS requirement: **Linux Ubuntu** or similar
* Run `apt-get install build-essential apache2-dev libjwt-dev`
* Run `make`
