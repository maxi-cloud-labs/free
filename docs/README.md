...
`docs` is the official documentation of mAxI.cloud and is leveraging [docsify](https://github.com/docsifyjs/docsify).
...
You will get the documentation folder `web`.
